...
geoips run data_fusion \
      ...
      --fuse_files $GEOIPS_TESTDATA_DIR/test_data_2024_tutorial/*ABI-L1b-RadF*.nc \
          ...
          --fuse_order 0 \
      --fuse_files $GEOIPS_OUTDIRS/preprocessed/algorithms/Cloud-Masked-Infrared_latitude_longitude/fusion/geo/conus/20230411/20230411.160020.* \
      ...
      --fuse_files $GEOIPS_TESTDATA_DIR/test_data_2024_tutorial/*TPW*.nc \
          ...
          --fuse_output_format imagery_clean \
          --fuse_order 2 \
      --fuse_files $GEOIPS_TESTDATA_DIR/test_data_noaa_aws/data/snpp/20230411/*/* \
          --fuse_reader_name viirs_sdr_hdf5 \
          --fuse_product_name Infrared \
          --fuse_dataset_name viirs_snpp \
          --fuse_output_format imagery_clean \
          --fuse_order 3
retval=$?
